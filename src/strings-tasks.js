...
function encodeToRot13(str) {
  return str
    ...
    .map((letter) => {
      ...
      if (unicodeIndex < 91 && unicodeIndex > 64) {
        return String.fromCodePoint(((unicodeIndex - 65 + 13) % 26) + 65);
      }
      if (unicodeIndex > 96 && unicodeIndex < 123) {
        return String.fromCodePoint(((unicodeIndex - 97 + 13) % 26) + 97);
      }
      return letter;
    })
    .join('');
